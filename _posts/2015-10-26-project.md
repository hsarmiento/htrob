...
**Diseño**
La aplicación constará de tres formularios: La Figura 2 representa el formulario para administrar las variables de entorno de ROS. La Figura 3 representa la lista de los robots actualmente configuración en el sistema indicando si están activos o no. La figura 4, representa las variable de entorno por cada robot(por ejemplo en la Figura se muestra toda las variables de Turtlebot). Los tres formularios contienen los siguiente elementos: 
